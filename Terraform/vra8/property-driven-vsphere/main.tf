...
module "vm" {
  ...
  folder = format("VRM-BACKUPEXCLUDED/demo/%s/%s", data.onefuse_static_property_set.group.properties.folderGroup, data.onefuse_static_property_set.environment.properties.folderEnv)
}