...
depends_on = [onefuse_microsoft_ad_computer_account.computer]
  ...
  clone {
    ...
    customize {
      ...
      dns_suffix_list = [ onefuse_naming.name.dns_suffix ]
      dns_server_list = [ onefuse_ipam_record.ipam-record.primary_dns, onefuse_ipam_record.ipam-record.secondary_dns]
    }
  }
}
